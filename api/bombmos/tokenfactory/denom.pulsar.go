...
func init() {
	...
	md_Denom = File_bombmos_tokenfactory_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_bombmos_tokenfactory_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "bombmos.tokenfactory.Denom.denom":
		return x.Denom != ""
	case "bombmos.tokenfactory.Denom.description":
		return x.Description != ""
	case "bombmos.tokenfactory.Denom.ticker":
		return x.Ticker != ""
	case "bombmos.tokenfactory.Denom.precision":
		return x.Precision != int32(0)
	case "bombmos.tokenfactory.Denom.url":
		return x.Url != ""
	case "bombmos.tokenfactory.Denom.maxSupply":
		return x.MaxSupply != int32(0)
	case "bombmos.tokenfactory.Denom.supply":
		return x.Supply != int32(0)
	case "bombmos.tokenfactory.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "bombmos.tokenfactory.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bombmos.tokenfactory.Denom"))
		}
		panic(fmt.Errorf("message bombmos.tokenfactory.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bombmos.tokenfactory.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "bombmos.tokenfactory.Denom.denom":
		panic(fmt.Errorf("field denom of message bombmos.tokenfactory.Denom is not mutable"))
	case "bombmos.tokenfactory.Denom.description":
		panic(fmt.Errorf("field description of message bombmos.tokenfactory.Denom is not mutable"))
	case "bombmos.tokenfactory.Denom.ticker":
		panic(fmt.Errorf("field ticker of message bombmos.tokenfactory.Denom is not mutable"))
	case "bombmos.tokenfactory.Denom.precision":
		panic(fmt.Errorf("field precision of message bombmos.tokenfactory.Denom is not mutable"))
	case "bombmos.tokenfactory.Denom.url":
		panic(fmt.Errorf("field url of message bombmos.tokenfactory.Denom is not mutable"))
	case "bombmos.tokenfactory.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message bombmos.tokenfactory.Denom is not mutable"))
	case "bombmos.tokenfactory.Denom.supply":
		panic(fmt.Errorf("field supply of message bombmos.tokenfactory.Denom is not mutable"))
	case "bombmos.tokenfactory.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message bombmos.tokenfactory.Denom is not mutable"))
	case "bombmos.tokenfactory.Denom.owner":
		panic(fmt.Errorf("field owner of message bombmos.tokenfactory.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bombmos.tokenfactory.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bombmos.tokenfactory.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: bombmos/tokenfactory/denom.proto
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_bombmos_tokenfactory_denom_proto_rawDescGZIP(), []int{0}
}
...
var File_bombmos_tokenfactory_denom_proto protoreflect.FileDescriptor

var file_bombmos_tokenfactory_denom_proto_rawDesc = []byte{
	,
	...
	,
}

var (
	file_bombmos_tokenfactory_denom_proto_rawDescOnce sync.Once
	file_bombmos_tokenfactory_denom_proto_rawDescData = file_bombmos_tokenfactory_denom_proto_rawDesc
)

func file_bombmos_tokenfactory_denom_proto_rawDescGZIP() []byte {
	file_bombmos_tokenfactory_denom_proto_rawDescOnce.Do(func() {
		file_bombmos_tokenfactory_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_bombmos_tokenfactory_denom_proto_rawDescData)
	})
	return file_bombmos_tokenfactory_denom_proto_rawDescData
}

var file_bombmos_tokenfactory_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_bombmos_tokenfactory_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: bombmos.tokenfactory.Denom
}
var file_bombmos_tokenfactory_denom_proto_depIdxs = []int32{
...
func init() { file_bombmos_tokenfactory_denom_proto_init() }
func file_bombmos_tokenfactory_denom_proto_init() {
	if File_bombmos_tokenfactory_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_bombmos_tokenfactory_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bombmos_tokenfactory_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_bombmos_tokenfactory_denom_proto_goTypes,
		DependencyIndexes: file_bombmos_tokenfactory_denom_proto_depIdxs,
		MessageInfos:      file_bombmos_tokenfactory_denom_proto_msgTypes,
	}.Build()
	File_bombmos_tokenfactory_denom_proto = out.File
	file_bombmos_tokenfactory_denom_proto_rawDesc = nil
	file_bombmos_tokenfactory_denom_proto_goTypes = nil
	file_bombmos_tokenfactory_denom_proto_depIdxs = nil
}
