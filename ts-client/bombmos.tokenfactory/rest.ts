...
/**
 * @title HTTP API Console bombmos.tokenfactory
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryDenomAll
   * @request GET:/bombmos/tokenfactory/denom
   */
  queryDenomAll = (
    query?: {
    ...
    >({
      path: `/bombmos/tokenfactory/denom`,
      method: "GET",
      query: query,
      ...params,
    });
   ...
   * @tags Query
   * @name QueryDenom
   * @request GET:/bombmos/tokenfactory/denom/{denom}
   */
  queryDenom = (denom: string, params: RequestParams = {}) =>
    this.request<
      ...
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
      path: `/bombmos/tokenfactory/denom/${denom}`,
      method: "GET",
      ...params,
    });
