...
import (
	...
	tokenfactorymodulev1 "bombmos/api/bombmos/tokenfactory/module"
	_ "bombmos/x/tokenfactory/module" // import for side-effects
	tokenfactorymoduletypes "bombmos/x/tokenfactory/types"
